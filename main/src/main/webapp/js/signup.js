...
const duplicate =()=> $.ajax({
	...
	url : 'http://14.36.141.71:10079/GDJ79_main_semi/member/logincheck',
	dataType :'json',
	data : {
		userId : $('#userId').val(),
...
const sendMail =()=> $.ajax({
	type : "post",
	async : true,
	url : 'http://14.36.141.71:10079/GDJ79_main_semi/member/sendEmail',
	dataType : 'json',
	data :{
		userId : $('#userId').val(),
		emailDomain : $('#emailDomain').val(),
...
const checkMailbtn =()=> $.ajax({
		type : "post",
		async : true,
		url : "http://14.36.141.71:10079/GDJ79_main_semi/member/mailck",
		dataType : 	"json",
		data : {
