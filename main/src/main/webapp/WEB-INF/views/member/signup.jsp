...
<section id="signupContainer">
	...
	<form action="<%=request.getContextPath()%>/member/signup"
		...
		<div class="groupJoin">
			...
			<span>-</span> <input type="number" name=memberCheckNoEnd>
		</div>
		<div class="groupJoin">
			<label for="phone">휴대폰</label> <input type="number" name="phone"
				id="phone" placeholder="010"> <span>-</span> <input
				type="number" name="phone1" id="phone1"> <span>-</span> <input
