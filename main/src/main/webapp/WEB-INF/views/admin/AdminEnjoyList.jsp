    ...
    <main class="main">
        ...
        <div class="container1">
            <select id="searchCategory" style="width: 100px; height: 25px;">
               <option value="tour" <%=searchCategory != null && searchCategory.equals("tour") ? "selected" : ""%>>TOUR</option>
                <option value="food" <%=searchCategory != null && searchCategory.equals("restaurant") ? "selected" : ""%>>RESTAURANT</option>
                <option value="cafe" <%=searchCategory != null && searchCategory.equals("cafe") ? "selected" : ""%>>CAFE</option>
            </select>

            <div id="search-tour" style="display:none;">
                <form action="<%=request.getContextPath()%>/admin/enjoy">
            ...
            <div id="search-food" style="display:none;">
                <form action="<%=request.getContextPath()%>/admin/enjoy">
            ...
            <div id="search-cafe" style="display:none;">
                <form action="<%=request.getContextPath()%>/admin/enjoy">
            ...
            <button type="button" id="insertNewEnjoy" onclick="location.href='<%=request.getContextPath()%>/admin/AdminEnjoyInsert.jsp'">신규등록</button>
        </div>
